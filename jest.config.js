...
// //   // cacheDirectory: "/private/var/folders/b7/9796vw050rvfwcxp6dzvl1dh0000gp/T/jest_dy",
...
module.exports = {
  ...
  moduleNameMapper: {
      '^componentreference/(.+)$':
          '<rootDir>/ui-lightning-docs-components/src/main/modules/componentreference/$1/$1',
      '^(lightning)/(.+)$':
          '<rootDir>/ui-lightning-docs-components/jest_modules/$1/$2/$2',
      '^(lightning)-(.+)$':
          '<rootDir>/ui-lightning-docs-components/jest_modules/$1/$2/$2'
  },
  ...
  coveragePathIgnorePatterns: ['/node_modules/', '/jest_modules/', '.html']
};
