export default function AuraInspectorTransactionGrid() {
    var tableBody;
    ...
    function generateTimelineColumn(timeline) {
        ...
        for (var c = 0; c < timeline.length; c++) {
            ...
            width = Math.max(((timeline[c + 1] - _gridRangeStartTime) / end) * 100 - left, 0.23);
    ...
    function createIndividualTimeline(stamp, start, end) {
        ...
        var minPercent = 0.23; // So you can actualy see a the small part on the timeline even when really short duration
