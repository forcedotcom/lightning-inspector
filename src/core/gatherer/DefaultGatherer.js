...
export default class DefaultGatherer extends Gatherer {
  ...
  constructor() {
    ...
    this.registerArtifact('networkResourceTimings',
      () => this.getNetworkResourceTimings(), { collectMethod: 'push', processor: 'FetchHeaders' });

    this.registerArtifact('window',
      () => this.getWindow(), { collectMethod: 'set' });
