        ...
        const audits = React.Children.map(children, (component, key) => {
            ...
            return (
                <div
                    ...
                    key={key}
                >
                    <RenderChildren className="audit-result-score" ref={`auditScore-${key}`}>
                        <Spinner height={10} width={10} strokeWidth={2} />
                    </RenderChildren>
                    <div className="audit-result-title">
                        <RenderChildren ref={`auditTitle-${key}`}>Running audit...</RenderChildren>
                    </div>
            ...
            <div className="audits">
                <div className="audits-header">
                    <div className="audits-toolbar">
                        ...
                        <span className="audits-score-label">
                            Overall
                            <br />
                            Score
                        </span>
                ...
                <div className="audits-body">
                    <SplitPane defaultSize={250} minSize={100} maxSize={-500}>
                ...
                <div style={{ display: 'none' }}>{runners}</div>
            </div>
        );
    }
}
