...
export default class AuraComponent extends React.Component {
    ...
    formatValue(value, expression) {
        ...
        if(value === null) {
            ...
            formattedValue = <React.Fragment>[<i className="component-array-length">{value.length}</i>]</React.Fragment>;
    ...
    formatAttributes() {
        ...
        Object.entries(attributes).forEach((item) => {
            ...
            elements.push(<span className="component-attribute" key={key}>
    ...
    render() {
        if(this.state.componentData) {
            ...
            return (<span className="auracomponent" onClick={this.handleOnClick} onDoubleClick={this.handleDblClick}>
